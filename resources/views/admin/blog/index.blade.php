            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{route('createBlog',['category'=>$category->id])}}"
            ...
            <table class="m-datatable" id="html_table" width="100%">
                ...
                @foreach($category->blogs as$blog )
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('editBlog',['category' => $category->id,'blog' => $blog->id]) }}"
                               class="btn btn-brand m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
                                <i class="fa flaticon-edit-1"></i>
                            </a>
                            <a href="#!"
                               data-url="{{ route('deleteBlog',['blog' => $blog->id,'category' => $category->id]) }}"
